...
def train(N, model_type):
    ...
    for epoch in range(1, args.NUMSTEPS):
        s = time.time()
...
if not os.path.exists(f'./Traditional_cluster_{args.NUMSTEPS}/{args.NAME}/'):
    os.makedirs(f'./Traditional_cluster_{args.NUMSTEPS}/{args.NAME}/Outputs/')
    os.makedirs(f'./Traditional_cluster_{args.NUMSTEPS}/{args.NAME}/Params/')

with open(__file__, 'r') as current_file:
    code_content = current_file.read()
    
with open(f'./Traditional_cluster_{args.NUMSTEPS}/{args.NAME}/train_backup.py', 'w') as backup_file:
