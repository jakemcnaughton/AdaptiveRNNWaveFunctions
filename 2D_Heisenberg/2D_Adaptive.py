...
def train():
    ...
    for dim in range(starting, args.MAX_POWER):
        ...
        if dim > starting:
            with open(f'../Results/2D_Heisenberg/{args.Nx}x{args.Ny}/Adaptive/{args.NAME}/Params/{dim}_{epoch}_params.pkl', 'wb') as f:
            ...
            results.to_csv(f'../Results/2D_Heisenberg/{args.Nx}x{args.Ny}/Adaptive/{args.NAME}/Outputs/{epoch}_outputs.csv')
